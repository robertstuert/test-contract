...
contract RocketPulseICO is OwnableUpgradeable {
    ...
    function getRoundNumber() public view returns (uint256) {
        ...
        if (deltaDays < 6) return 1;

        if (deltaDays > 50) return 25;

        return (deltaDays - 3) / 2;
    }
    ...
    function getRoundStartTime(
        ...
        return startTime + (roundNumber + 1) * 2 days;
    }
    ...
    function getCurrentTokenPrice() public view returns (uint256) {
        return
            [
                ...
                20000, // Round 1, Day 1, 2, 3, 4, 5, 6
                50000, // Round 2, Day 7, 8
                100000, // Round 3, Day 9, 10
                150000, // Round 4, Day 10, 11
                200000, // Round 5, Day 11, 12
                225000, // Round 6, Day 13, 14
                250000, // Round 7, Day 15, 16
                275000, // Round 8, Day 17, 18
                300000, // Round 9, Day 19, 20
                320000, // Round 10, Day 21, 22
                340000, // Round 11, Day 23, 24
                360000, // Round 12, Day 25, 26
                380000, // Round 13, Day 27, 28
                400000, // Round 14, Day 29, 30
                410000, // Round 15, Day 31, 32
                420000, // Round 16, Day 33, 34
                430000, // Round 17, Day 35, 36
                440000, // Round 18, Day 37, 38
                450000, // Round 19, Day 39, 40
                460000, // Round 20, Day 41, 42
                470000, // Round 21, Day 43, 44
                480000, // Round 22, Day 45, 46
                490000, // Round 23, Day 47, 48
                500000, // Round 24, Day 49, 50
                500000 // Round 25, Over Round, Day 51+
            ][getRoundNumber()];
    }
